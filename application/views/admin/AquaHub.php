                ...
                <div class="h-100 d-flex flex-column justify-content-center p-5">
                    ...
                    <form action="<?= base_url('proses_form'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="lokasi" id="lokasi" placeholder="Masukkan lokasi" autocomplete="off" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="jumlah_penduduk" id="jumlah_penduduk" required>
                        </div>

                        <div class="form-group">
                            <label for="jenis_sumur">Jenis Sumur:</label>
                            <input type="text" class="form-control" name="jenis_sumur" id="jenis_sumur" required>
                        </div>

                        <div class="form-group">
                            <label for="ketersediaan_air">Ketersediaan Air (dalam liter per hari):</label>
                            <input type="number" class="form-control" name="ketersediaan_air" id="ketersediaan_air" required>
                        </div>

                        <div class="form-group">
                            <label for="konsumsi_air">Konsumsi Air per Kapita (dalam liter per hari):</label>
                            <input type="number" class="form-control" name="konsumsi_air" id="konsumsi_air" required>
                        </div>
